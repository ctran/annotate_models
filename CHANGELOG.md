...
- Update rake requirement from `>= 10.4, < 13.0` to `>= 10.4, < 14.0` (https://github.com/ctran/annotate_models/pull/659)
- Bump nokogiri from 1.6.6.2 to 1.10.4 in /spec/integration/rails_4.2.0 (https://github.com/ctran/annotate_models/pull/655)
- Default annotate models to true in config generated by `rails g annotate:install` (https://github.com/ctran/annotate_models/pull/671)
- Bump loofah from 2.3.0 to 2.3.1 in /spec/integration/rails_4.2.0 (https://github.com/ctran/annotate_models/pull/681)

## 3.0.2
- Fixes `LoadError` due to gemspec not referencing `parser.rb`, issue https://github.com/ctran/annotate_models/issues/657 (https://github.com/ctran/annotate_models/pull/660)
- Changes `--additional_file_patterns` to use dashes `--additional-file-patterns` for consistency (https://github.com/ctran/annotate_models/pull/649)
- Refactor: moving constants into `constants.rb` (https://github.com/ctran/annotate_models/pull/653)

## 3.0.1
- Skipped as an official release, used the 3.0.1 patch for setting up Github Actions (https://github.com/ctran/annotate_models/pull/619)
...
- Added `--models` CLI option fixing issue https://github.com/ctran/annotate_models/issues/563 (https://github.com/ctran/annotate_models/pull/647)
- Added `--additional_file_patterns` option for additional file patterns (https://github.com/ctran/annotate_models/pull/633) (https://github.com/ctran/annotate_models/pull/636) (https://github.com/ctran/annotate_models/pull/637)
- Refactored CLI parser (https://github.com/ctran/annotate_models/pull/646)
- Fixed `BigDecimal.new` deprecation warning (https://github.com/ctran/annotate_models/pull/634)
- Fixed annotations for columns with long data types (https://github.com/ctran/annotate_models/pull/622)
- Made methods private in AnnotateRoutes (https://github.com/ctran/annotate_models/pull/598)
...
## 2.6.9
- Support foreigh key (https://github.com/ctran/annotate_models/pull/241)
- Check if model has skip tag in annotate_model_file (https://github.com/ctran/annotate_models/pull/167)
- Fix issue where serializer-related flags weren't being honored (https://github.com/ctran/annotate_models/issues/246)
- Prefer SQL column type over normalized AR type (https://github.com/ctran/annotate_models/issues/231)

## 2.6.8
- Nothing annotated unless `options[:model_dir]` is specified, https://github.com/ctran/annotate_models/pull/234

## 2.6.7
- Nothing annotated unless `options[:model_dir]` is specified, https://github.com/ctran/annotate_models/pull/234

## 2.6.6
- Makes it possible to wrap annotations, https://github.com/ctran/annotate_models/pull/225
- Fix single model generation, https://github.com/ctran/annotate_models/pull/214
- Fix default value for Rails 4.2, https://github.com/ctran/annotate_models/issues/212
- Don't crash on inherited models in subdirectories, https://github.com/ctran/annotate_models/issues/232
- Process model_dir in rake task, https://github.com/ctran/annotate_models/pull/197

## 2.6.4
- Skip "models/concerns", https://github.com/ctran/annotate_models/pull/194
- Fix https://github.com/ctran/annotate_models/issues/173 where annotate says "Nothing to annotate" in rails 4.2
- Display an error message if not run from the root of the project, https://github.com/ctran/annotate_models/pull/186
- Support rails 4.0 new default test directory, https://github.com/ctran/annotate_models/issues/182
- Add an option to show timestamp in routes "-timestamp", https://github.com/ctran/annotate_models/issues/136
- Skip plain ruby objects if they have the same class name as an ActiveRecord object, https://github.com/ctran/annotate_models/issues/121

## 2.6.3
- Fix bug of annotate position in routes (https://github.com/ctran/annotate_models/issues/158)

## 2.6.2
- Retain the current annotate block unless --force is specified
- Always load models, since they may not be autoloaded by Rails
- The pg array type is now detected (see https://github.com/ctran/annotate_models/pull/158)
